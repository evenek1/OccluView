...
/// Where the two scans are and how big they are — everything the runaway
...
/// scanner's choice of origin, not the fit. Real arches on this disk sit
/// between 4 mm and 71 mm from their own file zero, so that is not a corner
/// case — it is the ordinary spread of dental data.
#[derive(Clone, Copy, Debug, PartialEq)]
