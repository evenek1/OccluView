...
settings-save-format-source-hint = Uma digitalização aberta como STL é salva como STL, uma aberta como PLY como PLY, e uma de um formato sem gravação é salva no formato alternativo indicado abaixo.
