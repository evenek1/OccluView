...
settings-save-format-source-hint = Ein als STL geöffneter Scan wird als STL gespeichert, ein als PLY geöffneter als PLY, und ein Scan aus einem Format ohne Writer wird im unten genannten Ersatzformat gespeichert.
