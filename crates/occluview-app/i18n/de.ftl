...
settings-keep-source-format = Eigenes Format jedes Scans behalten
settings-keep-source-format-hint = Ein als STL geöffneter Scan wird als STL gespeichert, auch wenn unten ein anderes Format gewählt ist
