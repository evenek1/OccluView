...
settings-keep-source-format = Mantener el formato propio de cada escaneo
settings-keep-source-format-hint = Un escaneo abierto como STL se guarda como STL, aunque abajo se elija otro formato
