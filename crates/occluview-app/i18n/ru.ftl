...
settings-save-format-source-hint = Скан, открытый как STL, сохраняется как STL, как PLY — как PLY, а скан из формата без записи сохраняется в формате, указанном ниже.
