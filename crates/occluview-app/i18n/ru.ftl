...
settings-keep-source-format = Сохранять собственный формат скана
settings-keep-source-format-hint = Скан, открытый как STL, сохраняется как STL, даже если ниже выбран другой формат
