...
settings-save-format-source-hint = Una scansione aperta come STL viene salvata come STL, una aperta come PLY come PLY, e una da un formato senza scrittura viene salvata nel formato di ripiego indicato sotto.
...
settings-save-format-scene-note = Una scena intera salvata come un unico file usa sempre { $format }.
