...
settings-save-format-source-hint = Un scan ouvert en STL est enregistré en STL, un scan ouvert en PLY en PLY, et un scan issu d'un format sans écriture est enregistré dans le format de repli indiqué ci-dessous.
...
settings-save-format-scene-note = Une scène entière enregistrée en un seul fichier utilise toujours { $format }.
