...
settings-language-apply-system = Appliquer la langue du système
settings-language-restart-note = Manuel immédiat ; Système suit l’OS au démarrage.
...
settings-section-scene = Scène et caméra
